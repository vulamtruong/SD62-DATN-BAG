...
<div class="card shadow-sm mb-4">
    <div class="card-header bg-primary text-white">Thêm Thương Hiệu</div>
    <div class="card-body">
...
<div class="card shadow-sm">
    <div class="card-header bg-dark text-white">Danh sách thương hiệu</div>
    <div class="card-body">
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${listt}" var="p">
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="/thuong-hieu/detail/${p.id}" class="btn btn-info btn-sm">Chi tiết</a>
                            <a href="/thuong-hieu/view-update/${p.id}" class="btn btn-warning btn-sm">Cập nhật</a>
                            <a href="/thuong-hieu/remove/${p.id}" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa?')">Xóa</a>
                        </div>
                    </td>
                </tr>
            </c:forEach>
